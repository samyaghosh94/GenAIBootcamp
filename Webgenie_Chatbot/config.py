...
DOCX_SOURCE_PATH = "storage/HCM_Portal_User_Guide.docx"
ERROR_DOCX_PATH = "storage/HCM-Portal-TroubleshootingGuid.docx"
ERROR_PARSED_TEXT_PATH = "storage/error_parsed_texts.json"
